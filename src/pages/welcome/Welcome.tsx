  ...
  return (
    <main className="flex justify-center items-center h-screen bg-gray-100">
      <div className="p-4 bg-white rounded-xl shadow-lg flex flex-col items-start space-y-10 text-lg w-72">
        <h1 className="font-bold text-2xl">Welcome-Page:</h1>
        <p className="flex flex-col">
          Logged in as:
          <span className="mx-2 text-rose-900">"{name}"</span>with email:
          <span className="mx-2 text-rose-900">"{userData.email}".</span>
        </p>
        <button
